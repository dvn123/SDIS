 ...
 */
public class MulticastControlBackup implements Runnable {
    ...
    public MulticastControlBackup(String mc_ip, int mc_port) {
        this.mc_ip = mc_ip;
    ...
    private void listen() {
        ...
        MulticastControlBackupDataProcessing mcdt = new MulticastControlBackupDataProcessing(new String(recv.getData()).substring(0, recv.getLength()));
        mcdt.run();
    }
